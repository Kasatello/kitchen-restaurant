...
from kitchen.views import (
    ...
    DishTypeListView,
    DishListView,
    CookListView, DishTypeCreateView, DishTypeUpdateView, DishTypeDeleteView, DishDetailView, DishCreateView,
    DishUpdateView, DishDeleteView, CookDetailView, CookDeleteView, CookCreateView
)
